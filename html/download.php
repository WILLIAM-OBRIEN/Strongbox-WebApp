<?php
	...
	$fetch_privatekey = $conn->prepare("select user_privatekey from users where username=?");//gets private key linked to user (in encrypted format)
	$fetch_privatekey->bindParam(1,$username);
